/* Template Factory - DC Electric live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-dcelectric-sanbernardino/';
  var LS_CHANGES = 'tf_dce_change_log_v1';
  var LS_PURCHASED = 'tf_dce_purchased_v1';
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for DC Electric. Hang tight.',
        delay,
        function () {
